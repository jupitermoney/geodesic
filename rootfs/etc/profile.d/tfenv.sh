...
export TF_VAR_parent_domain_name="jupiter.money"
export TF_VAR_stage="${STAGE}"
export TF_VAR_domain_name="${TF_VAR_stage}.jupiter.money"
...
if isMounted "/secrets/tf"; then
	echo "already mounted in another shell"
else
	s3 mount
fi
